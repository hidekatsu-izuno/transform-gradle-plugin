 ...
 */
package net.arnx.gradle.repackaged.org.gradle.api.internal.file.copy;
...
import net.arnx.gradle.repackaged.org.gradle.api.internal.file.FileCollectionFactory;

import net.arnx.gradle.repackaged.org.gradle.api.internal.file.FileResolver;
import net.arnx.gradle.repackaged.org.gradle.api.internal.file.pattern.PatternMatcher;
import net.arnx.gradle.repackaged.org.gradle.api.internal.file.pattern.PatternMatcherFactory;
import org.gradle.api.specs.Spec;
import org.gradle.api.tasks.util.PatternSet;
import net.arnx.gradle.repackaged.org.gradle.internal.reflect.Instantiator;
import net.arnx.gradle.repackaged.org.gradle.internal.typeconversion.NotationParser;
...
public class DefaultCopySpec implements CopySpecInternal {
    ...
    protected CopySpecInternal addChildAtPosition(int position) {
        DefaultCopySpec child = instantiator.newInstance(SingleParentCopySpec.class, fileResolver, fileCollectionFactory, instantiator, buildRootResolver());
    ...
    public CopySpecInternal addChild() {
        DefaultCopySpec child = new SingleParentCopySpec(fileResolver, fileCollectionFactory, instantiator, buildRootResolver());
        addChildSpec(child);
        return child;
    }
